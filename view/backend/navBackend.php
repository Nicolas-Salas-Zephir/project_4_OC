<header class="header-admin">
    <nav class="navbar navbar-expand-md navbar-dark d-flex align-items-baseline justify-content-between">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            ...
            <?php endif; ?>
                <li class="nav-item">
                    <a class="nav-link mr-lg-3 text-center" href="index.php">Accédez au site</a>
                </li>
            <?php if(isset($_SESSION['pseudo']) && isset($_SESSION['id']) && isset($_SESSION['role']) && $_SESSION['role'] == 'modo'): ?>
                <li class="nav-item">
                        <a class="nav-link text-danger modo" href="index.php?action=logout">Commentaire dénoncé</a>
                </li>
            <?php endif; ?>
                <li class="nav-item">
